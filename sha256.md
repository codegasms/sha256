...
messageSchedule[i] = parsedMessage[i], if 0 <= i <= 15
messageSchedule[i] = σ1(messageSchedule[i - 2]) + messageSchedule[i - 7] + σ0(messageSchedule[i - 15]) + messageSchedule[i - 16] , if 16 <= i <= 63
